...
package com.github.yeriomin.yalpstore.sai.view;
...
import com.github.yeriomin.yalpstore.sai.fragment.details.Review;
import com.github.yeriomin.yalpstore.sai.task.playstore.ReviewAddTask;
...
public class UserReviewDialogBuilder extends DialogWrapper {
    ...
    public DialogWrapper show(final com.github.yeriomin.yalpstore.sai.model.Review review) {
    ...
    private class DoneOnClickListener implements DialogInterface.OnClickListener {
        ...
        private final com.github.yeriomin.yalpstore.sai.model.Review review;

        public DoneOnClickListener(com.github.yeriomin.yalpstore.sai.model.Review review) {
            this.review = review;
        }
